...
var postDataPro_PostTnews = function(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncryMMM(storageKeyName.MAINURL + 'PostTnewsChn', enData, commonData, 1, wd, callback);
}
...
var postDataPro_PostTnewsColl = function(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncryMMM(storageKeyName.MAINURL + 'PostTnewsColl', enData, commonData, 0, wd, callback);
}
//54.科教频道_个人收藏列表
//所需参数
//		var comData = {
...
var postDataPro_PostTnewsCollList = function(commonData, wd, callback) {
	...
	var enData = {};
	//发送网络请求，data为网络返回值
	postDataEncryMMM(storageKeyName.MAINURL +'PostTnewsCollList', enData, commonData, 1, wd, callback);
}
